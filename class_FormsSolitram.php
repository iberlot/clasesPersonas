        ...
        if ($tipo == '90' || $tipo == '07' || $tipo == '05' || $tipo == '06' || $tipo == '111' || $tipo == '112') {
            ...
            if ($aprobadas != "") {
                ...
                if (!$data) {
                    ...
                    if($total_horas <= 90){
                        $template .= '<p><br/>Para este formulario corresponde el <b>50%</b> del arancel correspondiente.</p>';
                    }else{
                        $template .= '<br/><p>Para este formulario corresponde el <b>100%</b> del arancel correspondiente.</p>';
                    }
                }
            } else {
