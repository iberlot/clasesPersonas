...
abstract class Personas {
    ...
    /*
     * ******************************************************************************
     * VARIABLES PARA MIGRACION DEL SIU
     * ******************************************************************************
     */
     ...
     * @var string
     */
    protected $localidad_nacim_nombre = null;
     ...
     * @var string
     */
    protected $partido_nacim_nombre = null;
     ...
     * @var string
     */
    protected $provincia_nacim_nombre = null;
     ...
     * @var string
     */
    protected $localidad_nombre = null;
     ...
     * @var string
     */
    protected $provincia_nombre = null;
     ...
     * @var int
     */
    protected $cobertura_salud = null;
     ...
     * @var int
     */
    protected $trabajo_hora_sem = null;
     ...
     * @var string
     */
    protected $trabajo_tarea_descripcion = null;
     ...
     * @var string
     */
    protected $turno_preferido_cursada = null;
    ...
    public function getDoc() {
        if (!isset($this->documentos[0])) {
            $docs = $this->buscar_perdoc_person($this->person);
            foreach ($docs as $doc) {
                error_log($doc['typdoc'] . " - " . $doc['docNumero']);
                $this->nuevo_documneto($doc['typdoc'], $doc['docNumero']);
    ...
    public function nuevo_documneto($tipo_doc, $nro_doc) {
        switch ($tipo_doc) {
            ...
            case "CUIL" :
                ...
                break;
            case "LC" :
                $this->documentos[] = new LCs($nro_doc);
                break;
            case "LE" :
                $this->documentos[] = new LEs($nro_doc);
                break;
            case "CI" :
            case "CIE" :
                $this->documentos[] = new CIs($nro_doc);
                break;
        }
    }
    ...
    /**
     * Busca y retorna el telefono asociado a una persona en base a su person
     */
    public function buscar_setear_telefono() {
        $buscar = array();
        $buscar['pattrib'] = 'TELE';
        $buscar['person'] = $this->person;

        if ($recu = $this->db->realizarSelectAll("appgral.apers", $buscar)) {
            $telefono = array();

            for ($i = 0; $i <= (count($recu['SHORTDES']) - 1); $i++) {
                if ($recu['SHORTDES'][$i] == 'PREFIJO') {
                    $telefono[0]['PREFIJO'] = $recu['VAL'][$i];
                } elseif ($recu['SHORTDES'][$i] == 'NUMERO') {
                    $telefono[0]['NUMERO'] = $recu['VAL'][$i];
                }
            }
        }
...
function setLocalidad_nacim_nombre($localidad_nacim_nombre) {
    $this->localidad_nacim_nombre = $localidad_nacim_nombre;
}

function setPartido_nacim_nombre($partido_nacim_nombre) {
    $this->partido_nacim_nombre = $partido_nacim_nombre;
}

function setProvincia_nacim_nombre($provincia_nacim_nombre) {
    $this->provincia_nacim_nombre = $provincia_nacim_nombre;
}
...
function setLocalidad_nombre($localidad_nombre) {
    $this->localidad_nombre = $localidad_nombre;
}

function setPartido_nombre($partido_nombre) {
    $this->partido_nombre = $partido_nombre;
}

function setProvincia_nombre($provincia_nombre) {
...
function setCantidad_hijos($cantidad_hijos) {
    $this->cantidad_hijos = $cantidad_hijos;
}

function setCobertura_salud($cobertura_salud) {
    $this->cobertura_salud = $cobertura_salud;
}

function setTrabajo_existe($trabajo_existe) {
    $this->trabajo_existe = $trabajo_existe;
}

function setTrabajo_hora_sem($trabajo_hora_sem) {
    $this->trabajo_hora_sem = $trabajo_hora_sem;
}

function setTrabajo_tarea_descripcion($trabajo_tarea_descripcion) {
    $this->trabajo_tarea_descripcion = $trabajo_tarea_descripcion;
}

function setTurno_preferido_cursada($turno_preferido_cursada) {
    $this->turno_preferido_cursada = $turno_preferido_cursada;
}
...
function getLocalidad_nacim_nombre() {
    return $this->localidad_nacim_nombre;
}

function getPartido_nacim_nombre() {
    return $this->partido_nacim_nombre;
}

function getProvincia_nacim_nombre() {
    return $this->provincia_nacim_nombre;
}
...
function getLocalidad_nombre() {
    return $this->localidad_nombre;
}

function getPartido_nombre() {
...
function getCantidad_hijos() {
    return $this->cantidad_hijos;
}

function getCobertura_salud() {
    return $this->cobertura_salud;
}

function getTrabajo_existe() {
    return $this->trabajo_existe;
}

function getTrabajo_hora_sem() {
    return $this->trabajo_hora_sem;
}

function getTrabajo_tarea_descripcion() {
    return $this->trabajo_tarea_descripcion;
}

function getTurno_preferido_cursada() {
    return $this->turno_preferido_cursada;
}
